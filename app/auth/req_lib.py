"""
Object enables user to make requests to Princeton's ActiveDirectory API
endpoint.
Taken from: https://github.com/vr2amesh/COS333-API-Code-Examples/blob/master/ActiveDirectory/python/req_lib.py
"""
